...
/** Infinity Get Image Id Manual */
function infinity_get_image_id_manual( $num = 0 ) {
...
/** Infinity Get Image Id Auto */
function infinity_get_image_id_auto( $num = 0 ) {
	
	/** Global Object */
	global $post;
	
	/** Manual Check At Priority */
	$id = infinity_get_image_id_manual( $num );
...
/** Infinity Get Image*/
function infinity_get_image( $args = array() ) {
	...
	$id = '';
	if( $args['mode'] == 'manual' ) {		
		$id = infinity_get_image_id_manual( $args['num'] );			
	} else {	
		$id = infinity_get_image_id_auto( $args['num'] );	
	}
